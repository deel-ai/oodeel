...
from keras.layers import Dense, Conv1D, Conv2D, Activation, GlobalAveragePooling1D, Dropout, Flatten, MaxPooling2D, Input
...
def generate_data(
    x_shape=(32, 32, 3), num_labels=10, samples=100, one_hot=True
    ):
